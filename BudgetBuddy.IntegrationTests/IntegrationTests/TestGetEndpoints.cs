...
public class TestGetEndpoints : IClassFixture<BudgetBuddyWebApplicationFactory<Program>>
{
    private readonly BudgetBuddyWebApplicationFactory<Program> _factory;
    private readonly ITestOutputHelper _testOutputHelper;
    private readonly HttpClient _client;

    public TestGetEndpoints(BudgetBuddyWebApplicationFactory<Program> factory, ITestOutputHelper testOutputHelper)
    {
        _factory = factory;
