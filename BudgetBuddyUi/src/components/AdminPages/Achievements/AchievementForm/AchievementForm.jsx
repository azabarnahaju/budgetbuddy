...
const AchievementForm = ({
  ...
  const handleAchievementTypeChange = e => {
    ...
    if (achievementType === "Exploration"){
      setObjective(allAchievementTypes[0])
    } else {
      setObjective("TransactionType");
    }
  }
  ...
  return (
    <div className="ach-form-container">
      ...
      <div className="ach-form-content">
        <form id="new-ach-form" onSubmit={handleSubmitOnForm}>
          <div className="mb-3">
            ...
            >
              {achievementType === "Exploration" ? (
                ...
                <>
                  ...
                  <option value="TransactionTag">TransactionTag</option>
                </>
              )}
            </select>
          </div>
